#line 1 "C:/Users/Fernando/Desktop/osa/RTOS_PROJETOS_CODIGO_FONTES_osa_110306 (4)/osa_110306/osa/apps/07_PROJETO_PAUSE_CONTINUE_THREAD/main.c"
...
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/07_projeto_pause_continue_thread/main.h"
...
#line 21 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/07_projeto_pause_continue_thread/main.h"
OST_MSG_CB msg_ad0;
OST_MSG_CB msg_ad1;
OST_MSG_CB msg_ad2;
OST_MSG_CB msg_pause;
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/07_projeto_pause_continue_thread/bsp.h"



void InitMCU (void);
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/07_projeto_pause_continue_thread/timer.h"
#line 14 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/07_projeto_pause_continue_thread/timer.h"
void TickTimerIE(void);
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/07_projeto_pause_continue_thread/lcd.h"
...
void InitLCD(void);
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/07_projeto_pause_continue_thread/button.h"
#line 8 "C:/Users/Fernando/Desktop/osa/RTOS_PROJETOS_CODIGO_FONTES_osa_110306 (4)/osa_110306/osa/apps/07_PROJETO_PAUSE_CONTINUE_THREAD/main.c"
...
void main (void)
{
 ...
 if (! _OS_Flags.bError ) tp1 =  &_OS_Tasks[_OS_Temp] ;
  ...
  { _OS_Task_Create(0, ( unsigned long )&(Task_AD1)); } ;
  { _OS_Task_Create(0, ( unsigned long )&(Task_AD2)); } ;
...
void Task_BUTTON0(void)
{
   { ; (msg_pause).status = 0; (msg_pause).msg = (OST_MSG)  0; ; } ;
 ...
 if (! (tp1)->State.bPaused ) {
   { if ( ((msg_pause).status & 1) ) { { _OS_EnterWaitMode(); asm{ nop } ; } ; _OS_CheckEvent((!((msg_pause).status & 1)) != 0) ; } ; (msg_pause).status = 1; (msg_pause).msg = (OST_MSG)  ("Pause"); } ;
 ...
 {
 if ( (tp1)->State.bPaused ) {
   { if ( ((msg_pause).status & 1) ) { { _OS_EnterWaitMode(); asm{ nop } ; } ; _OS_CheckEvent((!((msg_pause).status & 1)) != 0) ; } ; (msg_pause).status = 1; (msg_pause).msg = (OST_MSG)  ("Cont "); } ;
  { { _OS_EnterWaitMode(); asm{ nop } ; } ; _OS_CheckEvent((!((msg_pause).status & 1)) != 0) ; } ;
  { ;  { ; (tp1)->State.bPaused = 0; ; } ; ; } ;
 }
 }
