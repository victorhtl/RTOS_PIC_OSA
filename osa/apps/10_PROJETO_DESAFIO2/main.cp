#line 1 "C:/Users/Fernando/Desktop/osa/RTOS_PROJETOS_CODIGO_FONTES_osa_110306 (4)/osa_110306/osa/apps/10_PROJETO_DESAFIO2/main.c"
...
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/10_projeto_desafio2/main.h"
...
#line 19 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/10_projeto_desafio2/main.h"
OST_SMSG msg_ad0;
OST_SMSG msg_ad1;
OST_SMSG msg_ad2;
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/10_projeto_desafio2/bsp.h"



void InitMCU (void);
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/10_projeto_desafio2/timer.h"
#line 14 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/10_projeto_desafio2/timer.h"
void TickTimerIE(void);
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/10_projeto_desafio2/lcd.h"
...
void InitLCD(void);
#line 7 "C:/Users/Fernando/Desktop/osa/RTOS_PROJETOS_CODIGO_FONTES_osa_110306 (4)/osa_110306/osa/apps/10_PROJETO_DESAFIO2/main.c"
...
void Task_LCD(void)
{
 ...
 if ( ((msg_ad0) != (OST_SMSG)0) ) {
   { ;  { msg = msg_ad0; msg_ad0 = (OST_SMSG)0 ; } ; ; } ;
 WordToStr(msg, txt);
 Lcd_Out(1,1,(txt));
 }
 if ( ((msg_ad1) != (OST_SMSG)0) ) {
   { ;  { msg = msg_ad1; msg_ad1 = (OST_SMSG)0 ; } ; ; } ;
 WordToStr(msg, txt);
 Lcd_Out(1,10,(txt));
 }
 if ( ((msg_ad2) != (OST_SMSG)0) ) {
   { ;  { msg = msg_ad2; msg_ad2 = (OST_SMSG)0 ; } ; ; } ;
 WordToStr(msg, txt);
 Lcd_Out(2,1,(txt));
 }
...
void Task_AD0(void)
{
 ...
 {
 result = ADC_Read(0);
   { if ( ((msg_ad0) != (OST_SMSG)0) ) { { _OS_EnterWaitMode(); asm{ nop } ; } ; _OS_CheckEvent((((msg_ad0) == (OST_SMSG)0)) != 0) ; } ; msg_ad0 = (OST_SMSG) (result); } ;
  { { _OS_EnterWaitMode(); asm{ nop } ; } ; _OS_CheckEvent((!((msg_ad0) != (OST_SMSG)0)) != 0) ; } ;
...
void Task_AD1(void)
{
 ...
 {
 result = ADC_Read(1);
   { if ( ((msg_ad1) != (OST_SMSG)0) ) { { _OS_EnterWaitMode(); asm{ nop } ; } ; _OS_CheckEvent((((msg_ad1) == (OST_SMSG)0)) != 0) ; } ; msg_ad1 = (OST_SMSG) (result); } ;
  { { _OS_EnterWaitMode(); asm{ nop } ; } ; _OS_CheckEvent((!((msg_ad1) != (OST_SMSG)0)) != 0) ; } ;
...
void Task_AD2(void)
{
 ...
 {
 result = ADC_Read(2);
   { if ( ((msg_ad2) != (OST_SMSG)0) ) { { _OS_EnterWaitMode(); asm{ nop } ; } ; _OS_CheckEvent((((msg_ad2) == (OST_SMSG)0)) != 0) ; } ; msg_ad2 = (OST_SMSG) (result); } ;
  { { _OS_EnterWaitMode(); asm{ nop } ; } ; _OS_CheckEvent((!((msg_ad2) != (OST_SMSG)0)) != 0) ; } ;
