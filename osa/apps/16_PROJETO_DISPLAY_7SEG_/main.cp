#line 1 "C:/Users/Fernando/Desktop/osa/RTOS_PROJETOS_CODIGO_FONTES_osa_110306 (4)/osa_110306/osa/apps/16_PROJETO_DISPLAY_7SEG_/main.c"
...
#line 59 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/osacfg.h"
...
#line 155 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/kernel/events/osa_squeue.h"
...
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/16_projeto_display_7seg_/main.h"
...
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/16_projeto_display_7seg_/lcd.h"
...
void InitLCD(void);
#line 17 "C:/Users/Fernando/Desktop/osa/RTOS_PROJETOS_CODIGO_FONTES_osa_110306 (4)/osa_110306/osa/apps/16_PROJETO_DISPLAY_7SEG_/main.c"
...
void main (void)
{
 ...
 OS_Init();
  ...
  { _OS_Task_Create(0, ( unsigned long )&(Task_DISP7)); } ;
  { _OS_Task_Create(0, ( unsigned long )&(Task_BUTTON0)); } ;
  { _OS_Task_Create(0, ( unsigned long )&(Task_BUTTON1)); } ;

   { _OS_DI_INT() ; (queue).Q.cSize = 10; (queue).Q.cBegin = 0; (queue).Q.cFilled = 0; (queue).pMsg = (OST_MSG*)(buffer); _OS_RI_INT() ; } ;
...
void Task_DISP7(void)
{
 ...
 if ( ((queue).Q.cFilled) )
 {
   { _OS_DI_INT() ;  { Mat_Mostra_Disp = _OS_Queue_Get(&(queue)); } ; _OS_RI_INT() ; } ;
 }

 switch (_maq_estado)
 {
 case _disp1: {
 PORTD = Mat_Mostra_Disp[0];
  PORTA.RA0  = 1;
 _maq_estado = _disp2;
 break;
 }
 case _disp2: {
 PORTD = Mat_Mostra_Disp[1];
  PORTA.RA1  = 1;
 _maq_estado = _disp3;
 break;
 }
 case _disp3: {
 PORTD = Mat_Mostra_Disp[2];
  PORTA.RA2  = 1;
 _maq_estado = _disp4;
 break;
 }
 case _disp4: {
 PORTD = Mat_Mostra_Disp[3];
  PORTA.RA3  = 1;
 _maq_estado = _disp1;
 break;
 }
 default: break;
  ...
  { _OS_InitDelay(2 /1 ); { _OS_ReturnSave(); asm{ nop } ; } ; } ;
 }
}
...
void WriteEEPROM(unsigned int Contador)
{
 ...
 EEPROM_Write(0x00, ValWR.ValHighLow[0]);
 EEPROM_Write(0x01, ValWR.ValHighLow[1]);
}
...
void DispMsg(unsigned int Contador, char Enable)
{
 ...
 if (! ( _OS_DI_INT() ,_OS_Temp = ((queue).Q.cFilled == (queue).Q.cSize) , _OS_RI_INT() ,_OS_Temp) ) {
   { _OS_DI_INT() ; while ( ((queue).Q.cFilled == (queue).Q.cSize) ) { _OS_RI_INT() ; { { _OS_EnterWaitMode(); asm{ nop } ; } ; _OS_CheckEvent((!((queue).Q.cFilled == (queue).Q.cSize)) != 0) ; } ; _OS_DI_INT() ; } _OS_Queue_Send(&(queue), (OST_MSG) (buf)); _OS_RI_INT() ; } ;
 };
