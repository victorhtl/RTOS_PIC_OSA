#line 1 "C:/Users/Fernando/Desktop/osa/RTOS_PROJETOS_CODIGO_FONTES_osa_110306 (4)/osa_110306/osa/apps/15_PROJETO_SERIAL_9600_FILA_MSGs/main.c"
...
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/15_projeto_serial_9600_fila_msgs/main.h"
...
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/15_projeto_serial_9600_fila_msgs/lcd.h"
...
void InitLCD(void);
#line 7 "C:/Users/Fernando/Desktop/osa/RTOS_PROJETOS_CODIGO_FONTES_osa_110306 (4)/osa_110306/osa/apps/15_PROJETO_SERIAL_9600_FILA_MSGs/main.c"
...
void main (void)
{
 ...
 OS_Init();
  ...
  { _OS_Task_Create(2, ( unsigned long )&(Task_LED0)); } ;
...
void Task_LED0(void)
{
 ...
 LATD.RD0 = ~LATD.RD0;
 Delay_ms(2000);
  { ;  { ; (tp_Task)->State.bPaused = 1; ; } ; if ((tp_Task) == (_OS_CurTask)) {  { ; _OS_State.bPaused = 1; ; } ; { _OS_ReturnSave(); asm{ nop } ; } ; } ; } ;
