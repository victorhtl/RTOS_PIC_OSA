#line 1 "C:/Users/Fernando/Desktop/osa/RTOS_PROJETOS_CODIGO_FONTES_osa_110306 (4)/osa_110306/osa/apps/11_PROJETO_FILA_MSG_LCD_ADC/main.c"
...
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/11_projeto_fila_msg_lcd_adc/main.h"
...
#line 15 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/11_projeto_fila_msg_lcd_adc/main.h"
OST_QUEUE queue;
OST_MSG buffer[10];
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/11_projeto_fila_msg_lcd_adc/bsp.h"



void InitMCU (void);
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/11_projeto_fila_msg_lcd_adc/timer.h"
#line 14 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/11_projeto_fila_msg_lcd_adc/timer.h"
void TickTimerIE(void);
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/11_projeto_fila_msg_lcd_adc/lcd.h"
...
void InitLCD(void);
#line 7 "C:/Users/Fernando/Desktop/osa/RTOS_PROJETOS_CODIGO_FONTES_osa_110306 (4)/osa_110306/osa/apps/11_PROJETO_FILA_MSG_LCD_ADC/main.c"
...
void main (void)
{
 ...
 OS_Init();
  ...
  { _OS_Task_Create(0, ( unsigned long )&(Task_LCD)); } ;
   ...
   { ; (queue).Q.cSize = 10; (queue).Q.cBegin = 0; (queue).Q.cFilled = 0; (queue).pMsg = (OST_MSG*)(buffer); ; } ;
...
void Task_AD0(void)
{
 ...
 {
 result = ADC_Read(0);
 result = result * (255/1023.);
 WordToStr(result, buf);

 if (! ((queue).Q.cFilled == (queue).Q.cSize) ) {
   { if ( ((queue).Q.cFilled == (queue).Q.cSize) ) { { { _OS_EnterWaitMode(); asm{ nop } ; } ; _OS_CheckEvent((!((queue).Q.cFilled == (queue).Q.cSize)) != 0) ; } ; } _OS_Queue_Send(&(queue), (OST_MSG) (buf)); } ;

 };


  { _OS_InitDelay(200 /1 ); { _OS_ReturnSave(); asm{ nop } ; } ; } ;
 }
}
