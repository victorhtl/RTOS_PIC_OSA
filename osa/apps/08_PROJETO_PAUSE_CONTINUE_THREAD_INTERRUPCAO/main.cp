#line 1 "C:/Users/Fernando/Desktop/osa/RTOS_PROJETOS_CODIGO_FONTES_osa_110306 (4)/osa_110306/osa/apps/08_PROJETO_PAUSE_CONTINUE_THREAD_INTERRUPCAO/main.c"
...
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/08_projeto_pause_continue_thread_interrupcao/main.h"
...
#line 21 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/08_projeto_pause_continue_thread_interrupcao/main.h"
OST_MSG_CB msg_ad0;
OST_MSG_CB msg_ad1;
OST_MSG_CB msg_ad2;
OST_MSG_CB msg_pause;
OST_MSG_CB msg_int;
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/08_projeto_pause_continue_thread_interrupcao/bsp.h"
...
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/08_projeto_pause_continue_thread_interrupcao/lcd.h"
...
void InitLCD(void);
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/08_projeto_pause_continue_thread_interrupcao/button.h"
#line 8 "C:/Users/Fernando/Desktop/osa/RTOS_PROJETOS_CODIGO_FONTES_osa_110306 (4)/osa_110306/osa/apps/08_PROJETO_PAUSE_CONTINUE_THREAD_INTERRUPCAO/main.c"
...
void INTERRUPT_LOW() iv 0x0018 ics ICS_AUTO {
 ...
 if ( ((msg_pause).status & 1) ) {
   { msg = (msg_pause).msg; (msg_pause).status = 0 ; } ;

 LATD.RD6 = ~LATD.RD6;
 }

 if(! ((msg_int).status & 1) ){
   { _OS_Flags.bEventError = 0; if ( ((msg_int).status & 1) ) _OS_Flags.bEventError = 1; (msg_int).status = 1; (msg_int).msg = (OST_MSG)  ("int"); } ;
 }
...
void main (void)
{
 ...
 if (! _OS_Flags.bError ) tp1 =  &_OS_Tasks[_OS_Temp] ;
  ...
  { _OS_Task_Create(3, ( unsigned long )&(Task_LCD)); } ;
  { _OS_Task_Create(4, ( unsigned long )&(Task_BUTTON0)); } ;
...
void Task_LCD(void)
{
 ...
 if ( ((msg_ad0).status & 1) ) {
   { _OS_DI_INT() ; msg = (msg_ad0).msg; (msg_ad0).status = 0 ; _OS_RI_INT() ; } ;
 Lcd_Out(1,1,(msg));
 }
 if ( ((msg_ad1).status & 1) ) {
   { _OS_DI_INT() ; msg = (msg_ad1).msg; (msg_ad1).status = 0 ; _OS_RI_INT() ; } ;
 Lcd_Out(1,10,(msg));
 }
 if ( ((msg_ad2).status & 1) ) {
   { _OS_DI_INT() ; msg = (msg_ad2).msg; (msg_ad2).status = 0 ; _OS_RI_INT() ; } ;
 Lcd_Out(2,1,(msg));
 }
#line 102 "C:/Users/Fernando/Desktop/osa/RTOS_PROJETOS_CODIGO_FONTES_osa_110306 (4)/osa_110306/osa/apps/08_PROJETO_PAUSE_CONTINUE_THREAD_INTERRUPCAO/main.c"
...
void Task_AD0(void)
{
 static int result;
 static char buf[10];
   { _OS_DI_INT() ; (msg_ad0).status = 0; (msg_ad0).msg = (OST_MSG)  0; _OS_RI_INT() ; } ;

 for(;;)
 {
 result = ADC_Read(0);
 WordToStr(result, buf);
   { _OS_DI_INT() ; while ( ((msg_ad0).status & 1) ) { _OS_RI_INT() ; { { _OS_EnterWaitMode(); asm{ nop } ; } ; _OS_CheckEvent((!((msg_ad0).status & 1)) != 0) ; } ; _OS_DI_INT() ; }; (msg_ad0).status = 1; (msg_ad0).msg = (OST_MSG)  ((OST_MSG)buf); _OS_RI_INT() ; } ;
...
void Task_AD1(void)
{
 static int result;
 static char buf[10];
   { _OS_DI_INT() ; (msg_ad1).status = 0; (msg_ad1).msg = (OST_MSG)  0; _OS_RI_INT() ; } ;

 for(;;)
 {
 result = ADC_Read(1);
 WordToStr(result, buf);
   { _OS_DI_INT() ; while ( ((msg_ad1).status & 1) ) { _OS_RI_INT() ; { { _OS_EnterWaitMode(); asm{ nop } ; } ; _OS_CheckEvent((!((msg_ad1).status & 1)) != 0) ; } ; _OS_DI_INT() ; }; (msg_ad1).status = 1; (msg_ad1).msg = (OST_MSG)  ((OST_MSG)buf); _OS_RI_INT() ; } ;
...
void Task_AD2(void)
{
 static int result;
 static char buf[10];
   { _OS_DI_INT() ; (msg_ad2).status = 0; (msg_ad2).msg = (OST_MSG)  0; _OS_RI_INT() ; } ;

 for(;;)
 {
 result = ADC_Read(2);
 WordToStr(result, buf);
   { _OS_DI_INT() ; while ( ((msg_ad2).status & 1) ) { _OS_RI_INT() ; { { _OS_EnterWaitMode(); asm{ nop } ; } ; _OS_CheckEvent((!((msg_ad2).status & 1)) != 0) ; } ; _OS_DI_INT() ; }; (msg_ad2).status = 1; (msg_ad2).msg = (OST_MSG)  ((OST_MSG)buf); _OS_RI_INT() ; } ;
...
void Task_LED0 (void)
{
 ...
 if ( ((msg_int).status & 1) ) {
   { _OS_DI_INT() ; msg = (msg_int).msg; (msg_int).status = 0 ; _OS_RI_INT() ; } ;
 LATD.RD0 = ~LATD.RD0;
 }
...
void Task_BUTTON0(void)
{
   { _OS_DI_INT() ; (msg_pause).status = 0; (msg_pause).msg = (OST_MSG)  0; _OS_RI_INT() ; } ;
 ...
 if(LATD.RD7)
 {
 if (! (tp1)->State.bPaused ) {
   { _OS_DI_INT() ; while ( ((msg_pause).status & 1) ) { _OS_RI_INT() ; { { _OS_EnterWaitMode(); asm{ nop } ; } ; _OS_CheckEvent((!((msg_pause).status & 1)) != 0) ; } ; _OS_DI_INT() ; }; (msg_pause).status = 1; (msg_pause).msg = (OST_MSG)  ("Pause"); _OS_RI_INT() ; } ;
  { { _OS_EnterWaitMode(); asm{ nop } ; } ; _OS_CheckEvent((!((msg_pause).status & 1)) != 0) ; } ;
  { ;  { ; (tp1)->State.bPaused = 1; ; } ; if ((tp1) == (_OS_CurTask)) {  { ; _OS_State.bPaused = 1; ; } ; { _OS_ReturnSave(); asm{ nop } ; } ; } ; } ;
 }
 ...
 {
 if ( (tp1)->State.bPaused ) {
   { _OS_DI_INT() ; while ( ((msg_pause).status & 1) ) { _OS_RI_INT() ; { { _OS_EnterWaitMode(); asm{ nop } ; } ; _OS_CheckEvent((!((msg_pause).status & 1)) != 0) ; } ; _OS_DI_INT() ; }; (msg_pause).status = 1; (msg_pause).msg = (OST_MSG)  ("Cont "); _OS_RI_INT() ; } ;
  { { _OS_EnterWaitMode(); asm{ nop } ; } ; _OS_CheckEvent((!((msg_pause).status & 1)) != 0) ; } ;
  { ;  { ; (tp1)->State.bPaused = 0; ; } ; ; } ;
 }
 }
