#line 1 "C:/Users/Fernando/Desktop/osa/RTOS_PROJETOS_CODIGO_FONTES_osa_110306 (4)/osa_110306/osa/apps/14_PROJETO_PRIORIDADE_DAS_TASKS/main.c"
...
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/14_projeto_prioridade_das_tasks/main.h"
...
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/14_projeto_prioridade_das_tasks/bsp.h"
...
#line 1 "c:/users/fernando/desktop/osa/rtos_projetos_codigo_fontes_osa_110306 (4)/osa_110306/osa/apps/14_projeto_prioridade_das_tasks/lcd.h"
...
void InitUART(void);
void UartRx(void);
#line 8 "C:/Users/Fernando/Desktop/osa/RTOS_PROJETOS_CODIGO_FONTES_osa_110306 (4)/osa_110306/osa/apps/14_PROJETO_PRIORIDADE_DAS_TASKS/main.c"
OST_QUEUE queue;
OST_MSG buffer[10];
...
void main (void)
{
 ...
 OS_Init();
  ...
  { _OS_Task_Create(3, ( unsigned long )&(Task_DEC)); } ;
...
void Task_DEC(void)
{
 ...
 for(;;)
 {
   ...
   { for (;;) { { { _OS_EnterWaitMode(); asm{ nop } ; } ; _OS_CheckEvent((((queue).Q.cFilled)) != 0) ; } ; _OS_DI_INT() ; if ( ((queue).Q.cFilled) ) break; _OS_RI_INT() ; }  { dta = _OS_Queue_Get(&(queue)); } ; _OS_RI_INT() ; } ;
